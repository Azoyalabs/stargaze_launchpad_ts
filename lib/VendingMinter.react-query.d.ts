...
import { Timestamp, ConfigResponse, Coin, MintCountResponse, MintPriceResponse, MintableNumTokensResponse, StartTimeResponse, StatusResponse } from "./VendingMinter.types";
import { VendingMinterQueryClient, VendingMinterClient } from "./VendingMinter.client";
export declare const vendingMinterQueryKeys: {
    contract: readonly [{
        readonly contract: "vendingMinter";
    }];
    ...
    mintableNumTokens: (contractAddress: string | undefined, args?: Record<string, unknown>) => readonly [{
        readonly method: "mintable_num_tokens";
        readonly args: Record<string, unknown> | undefined;
        readonly address: string | undefined;
        readonly contract: "vendingMinter";
    }];
    startTime: (contractAddress: string | undefined, args?: Record<string, unknown>) => readonly [{
        readonly method: "start_time";
        readonly args: Record<string, unknown> | undefined;
        readonly address: string | undefined;
        readonly contract: "vendingMinter";
    }];
    mintPrice: (contractAddress: string | undefined, args?: Record<string, unknown>) => readonly [{
        readonly method: "mint_price";
        readonly args: Record<string, unknown> | undefined;
        readonly address: string | undefined;
        readonly contract: "vendingMinter";
    }];
    mintCount: (contractAddress: string | undefined, args?: Record<string, unknown>) => readonly [{
        readonly method: "mint_count";
        readonly args: Record<string, unknown> | undefined;
        readonly address: string | undefined;
        readonly contract: "vendingMinter";
    }];
