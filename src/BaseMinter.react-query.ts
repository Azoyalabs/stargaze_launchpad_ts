...
export const baseMinterQueryKeys = {
  ...
  address: (contractAddress: string | undefined) =>
    [{ ...baseMinterQueryKeys.contract[0], address: contractAddress }] as const,
  config: (
    ...
    [
      {
        ...baseMinterQueryKeys.address(contractAddress)[0],
        method: "config",
        args,
      },
    ] as const,
...
export interface BaseMinterStatusQuery<TData>
  extends BaseMinterReactQuery<StatusResponse, TData> {}
export function useBaseMinterStatusQuery<TData = StatusResponse>({
  ...
  return useQuery<StatusResponse, Error, TData>(
    baseMinterQueryKeys.status(client?.contractAddress),
    () =>
...
export interface BaseMinterConfigQuery<TData>
  extends BaseMinterReactQuery<ConfigResponse, TData> {}
export function useBaseMinterConfigQuery<TData = ConfigResponse>({
  client,
  options,
}: BaseMinterConfigQuery<TData>) {
  return useQuery<ConfigResponse, Error, TData>(
    baseMinterQueryKeys.config(client?.contractAddress),
    () =>
...
export function useBaseMinterUpdateStartTradingTimeMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      BaseMinterUpdateStartTradingTimeMutation
    >,
    "mutationFn"
  >
) {
...
export function useBaseMinterMintMutation(
  options?: Omit<
    UseMutationOptions<ExecuteResult, Error, BaseMinterMintMutation>,
    "mutationFn"
  >
) {
